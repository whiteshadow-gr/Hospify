...
/// A struct representing the profile data Google object from the received profile JSON file
public struct HATProfileDataProfileGoogleObject: Comparable {
    ...
    public static func == (lhs: HATProfileDataProfileGoogleObject, rhs: HATProfileDataProfileGoogleObject) -> Bool {
